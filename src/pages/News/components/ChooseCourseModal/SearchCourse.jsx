...
export const defaultSearchCourseValues = { typeActive: COURSE_STATUS[0].value, name: '' };

const SearchCourse = ({ setSearchParams }) => {
  const { handleSubmit, control, register, reset } = useForm({
    defaultValues: defaultSearchCourseValues
  });
  ...
  function handleReset() {
    reset();
    setSearchParams({ ...formatReq(defaultSearchCourseValues) });
  }
